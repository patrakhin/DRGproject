...
@Entity
@Table(name = "spare_parts_receipt")
public class SparePartsReceipt {
    @Id
    ...
    public SparePartsReceipt(){}

    public SparePartsReceipt(String region, String storageName, String employeeNumber, String sparePartName, String measure,
                             Long sparePartNumber, String transactionType, double quantity, LocalDate dateCreate) {
        this.region = region;
