...
/**
 * DTO for {@link SparePartsReceipt}
 */
public class SparePartsReceiptDto implements Serializable {
    private Long id;
    ...
    public SparePartsReceiptDto(){}

    public SparePartsReceiptDto(String region, String storageName, String employeeNumber, String sparePartName, String measure,
                                Long sparePartNumber, String transactionType, double quantity) {
        this.region = region;
